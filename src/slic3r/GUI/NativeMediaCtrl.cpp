...
StreamType NativeMediaCtrl::DetectStreamType(const wxString& url)
{
    ...
    if (url_lower.find(".mjpg") != std::string::npos ||
        url_lower.find(".mjpeg") != std::string::npos ||
        url_lower.find("mjpg") != std::string::npos ||
        url_lower.find("mjpeg") != std::string::npos ||
        url_lower.find("/video") != std::string::npos ||
        url_lower.find("/stream") != std::string::npos ||
        url_lower.find("/axis-cgi") != std::string::npos ||
        url_lower.find("/cgi-bin") != std::string::npos) {
